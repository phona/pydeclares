...
from pydeclares import var, NamingStyle, pascalcase_var, Declared, new_list_type
...
class NewVarDeclaredTestCase(unittest.TestCase):
	...
	def setUp(self):
		self.dt = datetime(2019, 8, 18, 10, 10, 10)
		self.timestamp = self.dt.timestamp()

	def test_str(self):
		json_obj = NewVarJsonTestClass(1, 2, self.dt)
		self.assertEqual(str(json_obj), "NewVarJsonTestClass(a=1,b=2,c=2019-08-18 10:10:10)")
